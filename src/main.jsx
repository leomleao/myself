...
const copy = {
  en: {
    ...
    footerLicense: 'Feel free to reach out for collaborations or just to say hi.',
  },
  pt: {
    ...
    footerTagline: 'Construindo coisas para a web.',
    footerRights: 'Todos os direitos reservados.',
    footerLicense: 'Entre em contato para colaboracoes ou so para dizer oi.',
  },
};
    ...
    <>
      ...
      <footer className="site-footer">
        <div className="footer-social">
          <a href="https://www.linkedin.com/in/leaoleo" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
            <LinkedInIcon />
          </a>
          <a href="https://github.com/leomleao" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
            <GitHubIcon />
          </a>
          <a href="mailto:leomleao@gmail.com" aria-label="Email">
            <EmailIcon />
          </a>
        </div>
        <p>
          &copy; <time>{new Date().getFullYear()}</time>{' '}
          <span className="footer-tooltip-wrap">
            <strong><a href="#top">Leo Leao</a></strong>.{' '}
            <span className="footer-tooltip">{t.footerTagline}</span>
          </span>
          <span className="footer-tooltip-wrap">
            {t.footerRights}
            <span className="footer-tooltip">{t.footerLicense}</span>
          </span>
        </p>
      </footer>
    </>
